...
public class FileOperations {
 ...
 public ArrayList<MyHeader> readFile(){
     String headerPath;
    //items file name
     String itemPath;
        File headerFile ;
        ...
        int result;
        ArrayList<MyHeader> invArray = new ArrayList<>();
            ...
            try {
                ...
                for (String headerLine : headerLines) {
                    ...
                    */
                    ...
                    MyHeader invoice = new MyHeader(num, customerName, date);
                ...
                for (String itemLine : itemLines) {
                    ...
                    MyHeader invoice=getInvoiceByNum(num);
                    MyItem line = new MyItem(name1,quantity,unitPrice,invoice);
 ...
 public void saveFile(ArrayList<MyHeader> headers) {
        ...
        */
        for(MyHeader header: headers){
            ...
            for(MyItem item : header.getItems()){
