...
import SIG.controller.MyController;
...
private ArrayList<MyItem> lines;
    ...
    public void setLines(ArrayList<MyItem> lines) {
        this.lines = lines;
    }
...
public ArrayList<MyHeader> getInvoices(){
    if(invoices==null){
    ...
    public void setInvoices(ArrayList<MyHeader> invoices) {
   ...
   public MyController getLisener(){
       return controller;
   }
